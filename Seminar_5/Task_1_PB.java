...
public class Task_1_PB {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("выбор действия: (add)добавить данные, (del)удалить данные, (num) найти владельца по номеру телефона, (sur)найти владельца по фамилии, " +
